...
namespace Gyvr.Mythril2D
{
    ...
    {
        [LabelText("投射物速度")] [SerializeField] private float m_projectileSpeed = 5.0f;
        [LabelText("投射物数量")] [SerializeField] private int m_projectileCount = 1;
        [LabelText("扩散度")] [SerializeField] private float m_spread = 0.0f;
